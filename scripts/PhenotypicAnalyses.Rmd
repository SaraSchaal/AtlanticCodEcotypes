...
write.csv(df.unknown, "/Users/saraschaal/Documents/Northeastern/LotterhosLab/Research/Data/CodEcotypes/AtlanticCodEcotypes/data/unknownIndv.csv")
...
## Plots ##
  ...
  arrows(x0 = GSIspringMean$CollectionDate, x1 = GSIspringMean$CollectionDate, 
         ...
         angle = 90, code = 3, len = 0.1)
  points(GonSomIndex~CollectionDate, data = GSIwinterMean, pch = 15, 
         col = "cornflowerblue")
  arrows(x0 = GSIwinterMean$CollectionDate, x1 = GSIwinterMean$CollectionDate, 
         y0 = GSIwinterMean$CIlow, y1 = GSIwinterMean$CIup, 
         angle = 90, code = 3, len = 0.1)
  legend("topleft", legend = c("Red", "Spring", "Winter"), pch = c(19,17,15), 
...
catchDepth <- read.csv("/Users/saraschaal/Documents/Northeastern/LotterhosLab/Research/Data/CodEcotypes/AtlanticCodEcotypes/data/catchdepth.csv", header = FALSE)
...
par(bty = "l")
boxplot(Depth~ColorType, ylim = rev(range(catchDepth$Depth)), data = catchDepth, col = c("firebrick", "lightblue"), ylab = "Catch Depth (m)")
